...
const pb_field_t google_firestore_v1beta1_WriteResult_fields[3] = {
    ...
    PB_FIELD(  2, MESSAGE , REPEATED, POINTER , OTHER, google_firestore_v1beta1_WriteResult, transform_results, update_time, &google_firestore_v1beta1_Value_fields),
    PB_LAST_FIELD
};
...
const pb_field_t google_firestore_v1beta1_DocumentChange_fields[4] = {
    ...
    PB_FIELD(  5, INT32   , REPEATED, POINTER , OTHER, google_firestore_v1beta1_DocumentChange, target_ids, document, 0),
    PB_FIELD(  6, INT32   , REPEATED, POINTER , OTHER, google_firestore_v1beta1_DocumentChange, removed_target_ids, target_ids, 0),
    PB_LAST_FIELD
};
