...
#ifndef PB_GOOGLE_FIRESTORE_V1BETA1_DOCUMENT_NANOPB_H_INCLUDED
#define PB_GOOGLE_FIRESTORE_V1BETA1_DOCUMENT_NANOPB_H_INCLUDED
#include <pb.h>
...
typedef struct _google_firestore_v1beta1_MapValue {
    ...
    struct _google_firestore_v1beta1_MapValue_FieldsEntry *fields;
...
#define google_firestore_v1beta1_Document_init_default {NULL, 0, NULL, google_protobuf_Timestamp_init_default, google_protobuf_Timestamp_init_default}
#define google_firestore_v1beta1_Document_FieldsEntry_init_default {NULL, google_firestore_v1beta1_Value_init_default}
#define google_firestore_v1beta1_Value_init_default {0, {0}}
#define google_firestore_v1beta1_ArrayValue_init_default {0, NULL}
#define google_firestore_v1beta1_MapValue_init_default {0, NULL}
#define google_firestore_v1beta1_MapValue_FieldsEntry_init_default {NULL, google_firestore_v1beta1_Value_init_default}
#define google_firestore_v1beta1_Document_init_zero {NULL, 0, NULL, google_protobuf_Timestamp_init_zero, google_protobuf_Timestamp_init_zero}
#define google_firestore_v1beta1_Document_FieldsEntry_init_zero {NULL, google_firestore_v1beta1_Value_init_zero}
#define google_firestore_v1beta1_Value_init_zero {0, {0}}
#define google_firestore_v1beta1_ArrayValue_init_zero {0, NULL}
#define google_firestore_v1beta1_MapValue_init_zero {0, NULL}
#define google_firestore_v1beta1_MapValue_FieldsEntry_init_zero {NULL, google_firestore_v1beta1_Value_init_zero}
