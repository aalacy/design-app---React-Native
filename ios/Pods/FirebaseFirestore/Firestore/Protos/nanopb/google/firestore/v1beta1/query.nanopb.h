...
#ifndef PB_GOOGLE_FIRESTORE_V1BETA1_QUERY_NANOPB_H_INCLUDED
#define PB_GOOGLE_FIRESTORE_V1BETA1_QUERY_NANOPB_H_INCLUDED
#include <pb.h>
...
typedef struct _google_firestore_v1beta1_StructuredQuery_Projection {
    ...
    struct _google_firestore_v1beta1_StructuredQuery_FieldReference *fields;
...
typedef struct _google_firestore_v1beta1_Cursor {
    ...
    struct _google_firestore_v1beta1_Value *values;
    bool before;
...
typedef struct _google_firestore_v1beta1_StructuredQuery_CompositeFilter {
    ...
    struct _google_firestore_v1beta1_StructuredQuery_Filter *filters;
...
typedef struct _google_firestore_v1beta1_StructuredQuery {
    ...
    struct _google_firestore_v1beta1_StructuredQuery_CollectionSelector *from;
    google_firestore_v1beta1_StructuredQuery_Filter where;
    pb_size_t order_by_count;
    struct _google_firestore_v1beta1_StructuredQuery_Order *order_by;
...
#define google_firestore_v1beta1_StructuredQuery_CollectionSelector_init_default {NULL, 0}
...
#define google_firestore_v1beta1_StructuredQuery_CompositeFilter_init_default {_google_firestore_v1beta1_StructuredQuery_CompositeFilter_Operator_MIN, 0, NULL}
#define google_firestore_v1beta1_StructuredQuery_FieldFilter_init_default {google_firestore_v1beta1_StructuredQuery_FieldReference_init_default, _google_firestore_v1beta1_StructuredQuery_FieldFilter_Operator_MIN, google_firestore_v1beta1_Value_init_default}
#define google_firestore_v1beta1_StructuredQuery_UnaryFilter_init_default {_google_firestore_v1beta1_StructuredQuery_UnaryFilter_Operator_MIN, 0, {google_firestore_v1beta1_StructuredQuery_FieldReference_init_default}}
#define google_firestore_v1beta1_StructuredQuery_Order_init_default {google_firestore_v1beta1_StructuredQuery_FieldReference_init_default, _google_firestore_v1beta1_StructuredQuery_Direction_MIN}
#define google_firestore_v1beta1_StructuredQuery_FieldReference_init_default {NULL}
#define google_firestore_v1beta1_StructuredQuery_Projection_init_default {0, NULL}
#define google_firestore_v1beta1_Cursor_init_default {0, NULL, 0}
#define google_firestore_v1beta1_StructuredQuery_init_zero {google_firestore_v1beta1_StructuredQuery_Projection_init_zero, 0, NULL, google_firestore_v1beta1_StructuredQuery_Filter_init_zero, 0, NULL, google_protobuf_Int32Value_init_zero, 0, google_firestore_v1beta1_Cursor_init_zero, google_firestore_v1beta1_Cursor_init_zero}
#define google_firestore_v1beta1_StructuredQuery_CollectionSelector_init_zero {NULL, 0}
...
#define google_firestore_v1beta1_StructuredQuery_CompositeFilter_init_zero {_google_firestore_v1beta1_StructuredQuery_CompositeFilter_Operator_MIN, 0, NULL}
#define google_firestore_v1beta1_StructuredQuery_FieldFilter_init_zero {google_firestore_v1beta1_StructuredQuery_FieldReference_init_zero, _google_firestore_v1beta1_StructuredQuery_FieldFilter_Operator_MIN, google_firestore_v1beta1_Value_init_zero}
#define google_firestore_v1beta1_StructuredQuery_UnaryFilter_init_zero {_google_firestore_v1beta1_StructuredQuery_UnaryFilter_Operator_MIN, 0, {google_firestore_v1beta1_StructuredQuery_FieldReference_init_zero}}
#define google_firestore_v1beta1_StructuredQuery_Order_init_zero {google_firestore_v1beta1_StructuredQuery_FieldReference_init_zero, _google_firestore_v1beta1_StructuredQuery_Direction_MIN}
#define google_firestore_v1beta1_StructuredQuery_FieldReference_init_zero {NULL}
#define google_firestore_v1beta1_StructuredQuery_Projection_init_zero {0, NULL}
#define google_firestore_v1beta1_Cursor_init_zero {0, NULL, 0}
...
#define google_firestore_v1beta1_StructuredQuery_UnaryFilter_size (2 + (google_firestore_v1beta1_StructuredQuery_FieldReference_size > 0 ? google_firestore_v1beta1_StructuredQuery_FieldReference_size : 0))
