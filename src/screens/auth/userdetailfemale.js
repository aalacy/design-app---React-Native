...
class UserDetailFemale extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        bust: 5,
      ...
      const body_type_female = this.props.navigation.getParam('body_type_female');
      ...
      const { bust, bra, waist, hips, shoes_size } = this.state;
	    return (
            ...
            <View style={{ flex: 1, alignItems: 'center' }}>
              ...
              <Text style={styles.label}>Bra</Text>
              <NumberSelectionList
                data={BraItems}
              />
              <Divider style={styles.divider}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserDetailFemale);
